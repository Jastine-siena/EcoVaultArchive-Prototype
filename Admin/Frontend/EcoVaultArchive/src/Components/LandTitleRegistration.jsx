...
const LandTitleRegistration = () => {
  ...
  const sourceTable = 'lt'; // Land Title Registration table
  const destinationTables = ['treecp', 'lr', 'cr', 'tp', 'tpr']; // List of destination tables
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-dark mb-4">Land Titles Registration Document Lists</h2>
      <div className="container mt-4">
