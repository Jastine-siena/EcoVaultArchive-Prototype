...
const DocumentList = () => {
  ...
  const sourceTable = 'treecp';
  const destinationTables = ['lt', 'cr', 'tp', 'tpr']; // List of destination tables
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-dark mb-4">Tree Cutting Permits Documents Lists</h2>
      <div className="container mt-4">
